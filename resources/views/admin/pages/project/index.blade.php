            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">VeloSwiftw</a></li>
                                            ...
                                            <form method="post" action="{{route('project.update',$projectData->id)}}" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="mb-3">
                                                            <label> Details </label>
                                                            <textarea class="form-control editor" name="details" style="height: 500px;" placeholder="Enter the Description">{!! $projectData->details !!}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="d-flex justify-content-end">
